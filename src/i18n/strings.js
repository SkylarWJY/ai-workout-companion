...
export const STRINGS = {
  en: {
    ...
    'log.rec.label': 'Suggested for this set',
    'log.rec.exceededRangeEasy': 'Blew past the top rep last time and it felt easy → load up.',
    'log.rec.exceededRange': 'Reps went past the top of range — time for a small bump.',
    'log.rec.easyAtTop': 'Hit the top rep with ease → small bump up.',
    ...
    'log.rec.failedReps': 'Last session failed reps → de-load 10% to consolidate.',
    'modal.progress': 'Progress',
    'modal.sessions': 'sessions',
    'modal.firstToLatest': 'First → latest',
    'custom.add': 'Add exercise',
    'custom.titleNew': 'Add custom exercise',
    'custom.titleEdit': 'Edit custom exercise',
    'custom.name': 'Exercise name',
    'custom.namePh': 'e.g. Cable Tricep Pushdown',
    'custom.primaryMuscle': 'Primary muscle',
    'custom.priority': 'Priority (for body-map intensity)',
    'custom.weightPh': 'e.g. 30 lb or DB 12.5 lb ea',
    'custom.tutorial': 'Tutorial video',
    'custom.tutorialHelp': 'Optional. Any YouTube link or 11-char ID.',
    'custom.errNoName': 'Give the exercise a name',
    ...
    'edit.exercise.sets': 'Sets',
    'edit.exercise.reps': 'Reps',
    'edit.exercise.rest': 'Rest (s)',
    'edit.exercise.tempo': 'Tempo',
    'edit.exercise.tempoHelp': '3-digit (lift-hold-lower) or 4-digit (lower-pause-lift-hold for compound lifts)',
  ...
  zh: {
    ...
    'log.variant': '变体',
    'log.lastTime': '上次',
    'log.rec.label': '本组建议重量',
    'log.rec.exceededRangeEasy': '上次冲过上限还很轻松 → 直接加重。',
    'log.rec.exceededRange': '上次冲过了 rep 上限 → 小幅加重。',
    'log.rec.easyAtTop': '上次刚好顶到上限觉得很轻松 → 小幅加重。',
    ...
    'log.rec.failedReps': '上次力竭没达到 reps → 减 10% 重量先稳一周。',
    'modal.progress': '进步',
    'modal.sessions': '次训练',
    'modal.firstToLatest': '首次 → 最新',
    'custom.add': '添加动作',
    'custom.titleNew': '添加自定义动作',
    'custom.titleEdit': '编辑自定义动作',
    'custom.name': '动作名称',
    'custom.namePh': '例如：绳索三头下压',
    'custom.primaryMuscle': '主练肌群',
    'custom.priority': '优先级（影响 body-map 强度）',
    'custom.weightPh': '例如：30 lb 或 哑铃 12.5 lb 每只',
    'custom.tutorial': '教学视频',
    'custom.tutorialHelp': '可选。任意 YouTube 链接或 11 位 ID。',
    'custom.errNoName': '给动作取个名字',
    ...
    'edit.exercise.sets': '组数',
    'edit.exercise.reps': '次数',
    'edit.exercise.rest': '休息（秒）',
    'edit.exercise.tempo': '节奏',
    'edit.exercise.tempoHelp': '3 位（发力-停顿-下放）或 4 位（下放-底部停顿-发力-顶部停顿，复合动作用）',
