...
// HONEST audit: only list a variant when I have a DISTINCT verified
// short tutorial video for it. Exercises with just one good clip get
// NO variant chips — the user isn't fooled into thinking they have
// options that all point at the same video.
//
...
const SKYLAR_VARIANTS = {
  ...
  's-pull-2': [
    ...
    { key: 'cable',    label: 'T-Bar Row',          labelZh: 'T 杆划船',
      youtubeId: '4v59ShSjX2w' },
    { key: 'dumbbell', label: 'Single-Arm DB Row',  labelZh: '单臂哑铃划船',
